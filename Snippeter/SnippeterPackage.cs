...
namespace Snippeter
{
	...
	{
		/// <summary>
		/// SnippeterPackage GUID string.
		/// </summary>
		public const string PackageGuidString = "e58ad809-e8fd-4595-bcf6-372c77484b11";
		...
		protected override async Task InitializeAsync( CancellationToken cancellationToken, IProgress<ServiceProgressData> progress )
		{
			...
			await SnippeterCommand.InitializeAsync( this, _dte );
		}
	}
}
